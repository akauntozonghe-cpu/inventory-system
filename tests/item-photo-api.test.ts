...
const mocks=vi.hoisted(()=>({admin:vi.fn(),login:vi.fn(),prepare:vi.fn(),db:{$transaction:vi.fn(),$queryRaw:vi.fn(),itemPhoto:{count:vi.fn(),create:vi.fn(),findFirst:vi.fn(),deleteMany:vi.fn()},adminActionLog:{create:vi.fn()}}}));
