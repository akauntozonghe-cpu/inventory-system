...
export default function SystemErrorDialog({open,code,title,message}:Props){return open?<FeedbackToast tone="error" title={title} errorCode={code} message={message}/>:null;}
