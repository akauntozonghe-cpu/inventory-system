const ACTION_LABELS: Record<string, string> = {
  ...
  INVENTORY_ARCHIVE: "個別在庫を廃止",
  INVENTORY_RESTORE: "個別在庫を復帰",
  INVENTORY_EXCLUDE_INSPECTION: "個別在庫を点検対象外に設定",
  INVENTORY_INCLUDE_INSPECTION: "個別在庫を点検対象に設定",
  ...
  CLASSIFICATION_CREATE_CLASSIFICATION: "分類を追加",
  CLASSIFICATION_RENAME_OR_MERGE_CLASSIFICATION: "分類を変更・統合",
  CLASSIFICATION_DELETE_CLASSIFICATION: "未使用分類を削除",
  CLASSIFICATION_CREATE_LOCATION: "保管場所を追加",
  CLASSIFICATION_RENAME_LOCATION: "保管場所名を変更",
  CLASSIFICATION_MERGE_LOCATION: "保管場所と在庫を統合",
