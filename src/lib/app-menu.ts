...
export const appMenu: ReadonlyArray<{ title: string; links: MenuLink[] }> = [
  ...
  {title:"フリマ",links:[{href:"/marketplace",label:"出品・発送",feature:"MARKETPLACE"},{href:"/admin/marketplace/advisor",label:"価格・送料を試算",feature:"MARKETPLACE"},{href:"/admin/marketplace/settings",label:"販売・配送の設定",feature:"MARKETPLACE_SETTINGS"}]},
  {title:"設定",links:[{href:"/account/password",label:"パスワード変更"},{href:"/admin",label:"管理者設定",admin:true},{href:"/admin/classifications",label:"分類・保管場所・JANの整理",admin:true},{href:"/admin/users",label:"ユーザー・権限管理",admin:true},{href:"/admin/system-check",label:"システム点検・復旧",admin:true}]},
];
