...
export type JournalRow = { id: string; at: string; kind: string; subject: string; detail: string; operator: string; href: string | null; accessLabel?: string; fields: JournalField[]; note?: string };
