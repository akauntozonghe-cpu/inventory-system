...
useEffect(() => {
  ...
  const createDraft = async () => {
    ...
    try {
      ...
      setInventoryId(""); setTitle(""); setDescription(""); setPrice(""); setShippingCost("");setQuantity("1");setShippingMethod("");setChannel("mercari");setCondition("目立った傷や汚れなし");setInventoryQuery("");setDebouncedQuery("");setCategoryFilter("");setLocationFilter("");
